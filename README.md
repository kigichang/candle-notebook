...
1. [以推論為主軸，介紹如何使用 Huggingface Candle](tutorial/README.md)
    ...
    1. [使用量化模型 (GGUF) 進行文字生成](tutorial/5.generation-gguf/README.md): 介紹如何使用 Huggingface Candle 與量化模型[Qwen2.5-3B-Instruct-GGUF](https://huggingface.co/Qwen/Qwen2.5-3B-Instruct-GGUF) 進行文字生成。
